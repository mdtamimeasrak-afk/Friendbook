...
function socialhubBirthdaysCard(item, isToday, age) {
    ...
    const avatar =
        item.avatar_url
            ? `<img class="birthday-avatar" src="${socialhubBirthdaysEscape(item.avatar_url)}" alt="" onclick="location.href='user-profile.html?user=${item.id}'">`
            : `<div class="birthday-avatar" onclick="location.href='user-profile.html?user=${item.id}'">${socialhubBirthdaysEscape((item.full_name || "U").charAt(0).toUpperCase())}</div>`;
    ...
    card.innerHTML = `
        ...
        <div class="birthday-info">
            ...
            <b onclick="location.href='user-profile.html?user=${item.id}'">
