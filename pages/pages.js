    ...
    modal.innerHTML = `
        <div class="socialhub-cr-box">
            ...
            <div class="cr-body">
                ...
                <input type="text" id="pgName" placeholder="e.g. Friendio Official" maxlength="60">
    ...
    modal
        ...
        .addEventListener("click", async () => {
            ...
            setTimeout(() => {
                ...
                location.href = `../pages/page.html?id=${data.id}`;
            }, 700);
        });
}
...
async function socialhubPagesLoad() {
    ...
    pages.forEach(page => {
        ...
        card.addEventListener("click", () => {
            ...
            location.href = `../pages/page.html?id=${page.id}`;
        });
...
async function socialhubPageLoad() {
    ...
    document.title = page.name + " - Friendio";
