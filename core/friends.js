...
async function socialhubRenderFriendsTab(status, modal) {
    ...
    rows.forEach(row => {
        ...
        const name =
            profile?.full_name || "Friendio User";
        ...
        rowElement.innerHTML = `
            ...
            <div
                ...
                onclick="location.href='../profile/user-profile.html?user=${otherId}'"
            >
                <strong>
    ...
    candidates.forEach(profile => {
        ...
        suggestion.innerHTML = `
            ...
            <div
                ...
                onclick="location.href='../profile/user-profile.html?user=${profile.id}'"
                ...
                .addEventListener("click", event => {
                    ...
                    if (typeof socialhubOpenChatPopup === "function") {
                        ...
                        window.location.href =
                            `../profile/user-profile.html?user=${profile.id}`;
                    }
                });
        ...
        .forEach(friend => {
            ...
            item.addEventListener(
                ...
                () => {
                    ...
                    window.location.href =
                        `../profile/user-profile.html?user=${friend.id}`;
                }
            );
...
function socialhubCreateUpTile(post) {
    ...
    tile.addEventListener("click", () => {
        ...
        if (post.video_url) {
            ...
            location.href =
                `../watch/index.html?video=${post.id}`;
