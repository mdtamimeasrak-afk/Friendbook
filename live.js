...
async function socialhubLiveLoad() {
    ...
    sessions.forEach(session => {
        ...
        card.addEventListener("click", () => {
            ...
            location.href = `live-room.html?id=${session.id}`;
        });
...
async function socialhubLiveRoomLoad() {
    ...
    document.title = session.title + " - TRIYA Live";
        ...
        <div class="live-room-info">
            ...
            <div class="live-room-host">
                ...
                <div>
                    ...
                    <small>Started ${socialhubLiveElapsed(session.started_at)} ago · Live on TRIYA</small>
                </div>
