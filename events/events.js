    ...
    modal
        ...
        .addEventListener("click", async () => {
            ...
            setTimeout(() => {
                ...
                location.href = `../events/event.html?id=${data.id}`;
            }, 700);
        });
}
...
async function socialhubEventsLoad() {
    ...
    events.forEach((event, index) => {
        ...
        card.addEventListener("click", () => {
            ...
            location.href = `../events/event.html?id=${event.id}`;
        });
...
async function socialhubEventLoad() {
    ...
    box.querySelectorAll(".attendee-chip").forEach(chip => {
        ...
        chip.addEventListener("click", () => {
            ...
            location.href = `../profile/user-profile.html?user=${chip.dataset.uid}`;
        });
    });
}
...
document.addEventListener("DOMContentLoaded", () => {
    ...
    if (page === "../events/index.html") {

        socialhubEventsLoad();
    }

    if (page === "../events/event.html") {
